...
SECRET_KEY = 'django-insecure-v@b$mrssr$n)-dz55mo69fvsx-jv=*eq%j*%*lq6(f$u(fa!e4'
...
mpl.rcParams['font.sans-serif'] = [
    ...
    'MS Gothic',         # Windows
    'Meiryo',            # Windows
    'IPAexGothic',       # Linux（apt install fonts-ipafont）
    'TakaoPGothic',      # Linux（apt install fonts-takao-pgothic）
    'Hiragino Sans',     # macOS
]
